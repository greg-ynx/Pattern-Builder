...
class UiMainWindow(object):
    ...
    def __init__(self, main_window):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../assets/img/pattern_builder_logo_c_800px.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../../../../src/img/Material design/FileMenu/Export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menu_pattern.setIcon(icon)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../assets/img/NewFile.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new.setIcon(icon3)
        self.action_new.setObjectName("action_new")
        self.action_open = QtWidgets.QAction(main_window)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../assets/img/OpenFile.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_open.setIcon(icon4)
        self.action_open.setObjectName("action_open")
        self.action_save = QtWidgets.QAction(main_window)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../assets/img/Save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_save.setIcon(icon5)
        self.action_save.setObjectName("action_save")
        self.action_save_as = QtWidgets.QAction(main_window)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../assets/img/SaveAs.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../../assets/img/QuestionMark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_help.setIcon(icon7)
        self.action_help.setObjectName("action_help")
        self.action_about_pb = QtWidgets.QAction(main_window)
        self.action_about_pb.setIcon(icon)
        self.action_about_pb.setObjectName("action_about_pb")
        self.action_about_author = QtWidgets.QAction(main_window)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../../assets/img/lyl8Lynx_logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_about_author.setIcon(icon8)
        self.action_about_author.setObjectName("action_about_author")
        self.action_join_us = QtWidgets.QAction(main_window)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../../assets/img/GitHub.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_join_us.setIcon(icon9)
